...
CREATE TABLE IF NOT EXISTS workshop_registrations (
    ...
    UNIQUE (workshop_id, student_id)  -- one registration per student per workshop
);
...
CREATE INDEX IF NOT EXISTS idx_workshop_registrations_student ON workshop_registrations(student_id);
CREATE INDEX IF NOT EXISTS idx_workshop_progress_student ON workshop_progress(student_id);
